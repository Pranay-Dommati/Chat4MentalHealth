...
export default function Layout() {
  ...
  const currentPath = location.pathname.split('/')[1] || 'dashboard';  const menuItems = [
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <aside className="w-72 bg-white dark:bg-gray-800 shadow-lg flex flex-col p-6 border-r border-gray-200 dark:border-gray-700">
      ...
      </aside>      <main className="flex-1 flex flex-col overflow-hidden">
        {currentPath !== 'chat' && currentPath !== 'community' && (
        ...
        <div className={`flex-1 overflow-hidden ${currentPath === 'chat' || currentPath === 'community' ? '' : 'p-8 pt-4'}`}>
          <Outlet />
        </div>
      </main>
    </div>
